...
class Screen {
  public:
    ...
    virtual bool touch(const TouchInput &touch)
    {
        return false;
    }
    ...
    virtual bool axis(const AxisInput &touch)
    {
        return false;
    }
...
class ScreenManager {
  public:
    ...
    void setThin3DContext(Thin3DContext *context)
    {
        thin3DContext_ = context;
    }
    Thin3DContext *getThin3DContext()
    {
        return thin3DContext_;
    }
