...
StereoResampler::StereoResampler() : m_dma_mixer(this, 44100)
{
...
unsigned int StereoResampler::MixerFifo::Mix(short *samples, unsigned int numSamples, bool consider_framelimit,
                                             int sample_rate)
{
